...
export default function KSAMajorAirports() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'DELAYS': case 'HEAVY': return 'text-yellow-500';
      case 'LOW_TRAFFIC': return 'text-blue-400';
  ...
  return (
    <div className="widget-card p-3">
      <span className="text-[10px] font-bold uppercase text-gray-500 block mb-3">KSA Major Airports</span>
