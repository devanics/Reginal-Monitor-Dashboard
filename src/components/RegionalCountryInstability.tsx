...
const COUNTRIES = [
    { code: 'ae', name: 'UAE', score: 15, level: 'normal', unrest: 10, conflict: 0, security: 20, information: 10 },
    { code: 'bh', name: 'Bahrain', score: 25, level: 'normal', unrest: 15, conflict: 0, security: 25, information: 15 },
    { code: 'om', name: 'Oman', score: 10, level: 'normal', unrest: 5, conflict: 0, security: 15, information: 5 },
    { code: 'qa', name: 'Qatar', score: 20, level: 'normal', unrest: 12, conflict: 0, security: 22, information: 12 },
    { code: 'ir', name: 'Iran', score: 85, level: 'critical', unrest: 90, conflict: 95, security: 40, information: 80 },
    { code: 'il', name: 'Israel', score: 75, level: 'high', unrest: 18, conflict: 45, security: 30, information: 54 },
    { code: 'kw', name: 'Kuwait', score: 22, level: 'normal', unrest: 15, conflict: 0, security: 20, information: 15 },
    { code: 'tr', name: 'Turkey', score: 55, level: 'elevated', unrest: 45, conflict: 30, security: 60, information: 40 },
    { code: 'sa', name: 'Saudi Arabia', score: 45, level: 'stable', unrest: 32, conflict: 0, security: 35, information: 50 }
];
    ...
    return (
        <div className="widget-card flex flex-col h-full bg-black/40 border-l-0 border-r-0 rounded-none max-h-[800px]">
            ...
            <div className="widget-content flex-1 overflow-y-auto px-4 py-4 custom-scrollbar flex flex-col gap-3">
                {countries.map((c) => {
                    const colorClass = getLevelColor(c.status);
                    ...
                    return (
                        ...
                        >
                            <div className="flex justify-between items-center mb-2">
                                <div className="flex items-center gap-2">
                                    <div className={`w-3 h-3 rounded-full ${barColor} shadow-[0_0_8px_currentColor]`}></div>
